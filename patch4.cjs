...
const startIndex = content.indexOf('<div className="answers-title">Đáp án Mã đề {exam.code}:</div>');
const endIndexStr = '</>';
...
if (startIndex !== -1 && endIndex !== -1) {
  ...
  content = content.substring(0, startIndex) + newAnswerHtml + content.substring(endIndex);
